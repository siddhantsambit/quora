...
public class AnswerControllerTest {
    ...
    public void createAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/database_question_uuid/answer/create?answer=my_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer non_existing_access_token"))
    ...
    public void createAnswerWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/database_question_uuid/answer/create?answer=my_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer database_accesstoken3"))
                .andExpect(status().isForbidden())
    ...
    public void createAnswerForNonExistingQuestion() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/non_existing_question_uuid/answer/create?answer=my_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer database_accesstoken"))
    ...
    public void editAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid?content=edited_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer non_existing_access_token"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-001"));
    }
    ...
    public void editAnswerWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid?content=edited_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer database_accesstoken3"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-002"));
    }
    ...
    public void editNonExistingAnswer() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/non_existing_answer_uuid?content=edited_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer database_accesstoken1"))
                .andExpect(status().isNotFound())
    ...
    public void editAnswerWithoutOwnership() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid?content=edited_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("accessToken", "Bearer database_accesstoken"))
                .andExpect(status().isForbidden())
    ...
    public void deleteAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.delete("/answer/delete/database_answer_uuid").header("accessToken", "Bearer non_existing_access_token"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-001"));
    }
    ...
    public void deleteAnswerWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.delete("/answer/delete/database_answer_uuid").header("accessToken", "Bearer database_accesstoken3"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-002"));
    }
    ...
    public void deleteNonExistingAnswer() throws Exception {
        mvc.perform(MockMvcRequestBuilders.delete("/answer/delete/non_existing_answer_uuid").header("accessToken", "Bearer database_accesstoken1"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ANS-001"));
    }
    ...
    public void deleteAnswerWithoutOwnership() throws Exception {
        mvc.perform(MockMvcRequestBuilders.delete("/answer/delete/database_answer_uuid").header("accessToken", "Bearer database_accesstoken2"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-003"));
    }
    ...
    public void getAllAnswersToQuestionWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/answer/all/database_question_uuid").header("accessToken", "Bearer non_existing_access_token"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-001"));
    }
    ...
    public void getAllAnswersToQuestionWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/answer/all/database_question_uuid").header("accessToken", "Bearer database_accesstoken3"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-002"));
    }
    ...
    public void getAllAnswersToNonExistingQuestion() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/answer/all/non_existing_question_uuid").header("accessToken", "Bearer database_accesstoken"))
                .andExpect(status().isNotFound())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("QUES-001"));
    }
